...
public class LoginDAOImpl implements LoginDAO,UserDetailsService{
	...
	public UserDetails loadUserByUsername(String userName)
		...
		if(userLoginDetails!=null)
			authorities= buildUserAuthority(this.get(userLoginDetails.getLoginId()));
	...
	private List<GrantedAuthority> buildUserAuthority(Login userLogin) {

		Set<GrantedAuthority> setAuths = new HashSet<GrantedAuthority>();

		// Build user's authorities
		setAuths.add(new SimpleGrantedAuthority(userLogin.getRoles().getRole()));
